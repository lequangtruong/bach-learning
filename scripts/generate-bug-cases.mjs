// scripts/generate-bug-cases.mjs
// Script tạo ngân hàng 120 bài tập bẫy lỗi sai (Spot The Bug) chuẩn mực Toán Lớp 4
...
export const TOPICS = [
  {
    ...
    cases: [
      {
        title: "Bẫy Cộng trước nhân sau trong biểu thức hỗn hợp",
        problem: "Tính giá trị của biểu thức: 4 500 + 1 500 × 4 − 3 200 : 8",
        steps: [
          { num: 1, text: "Thực hiện lần lượt từ trái sang phải: 4 500 + 1 500 = 6 000", isBug: true },
          { num: 2, text: "Nhân tiếp với 4: 6 000 × 4 = 24 000", isBug: false },
          { num: 3, text: "Thực hiện phép chia: 3 200 : 8 = 400", isBug: false },
          { num: 4, text: "Lấy 24 000 − 400 = 23 600", isBug: false }
        ],
      ...
      {
        title: "Bẫy Phép cộng làm trước phép trừ cùng cấp",
        problem: "Tính giá trị của biểu thức: 15 400 − 4 800 + 3 200",
        steps: [
          { num: 1, text: "Thực hiện phép cộng phía sau trước: 4 800 + 3 200 = 8 000", isBug: true },
          { num: 2, text: "Lấy số ban đầu trừ đi kết quả: 15 400 − 8 000 = 7 400", isBug: false },
          { num: 3, text: "Kết luận giá trị biểu thức là 7 400", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nhân trước chia sau khi cùng mức ưu tiên",
        problem: "Tính giá trị của biểu thức: 36 000 : 60 × 5",
        steps: [
          { num: 1, text: "Thực hiện phép nhân phía sau trước: 60 × 5 = 300", isBug: true },
          { num: 2, text: "Lấy 36 000 chia cho 300: 36 000 : 300 = 120", isBug: false },
          { num: 3, text: "Kết luận giá trị biểu thức là 120", isBug: false }
        ],
      ...
      {
        title: "Bẫy Trừ trước nhân sau trong dấu ngoặc đơn",
        problem: "Tính giá trị: 25 000 + 12 000 : (150 − 50 × 2)",
        steps: [
          { num: 1, text: "Trong ngoặc, tính từ trái sang phải: 150 − 50 = 100", isBug: true },
          { num: 2, text: "Nhân tiếp với 2: 100 × 2 = 200", isBug: false },
          { num: 3, text: "Lấy 12 000 chia cho kết quả trong ngoặc: 12 000 : 200 = 60", isBug: false },
          { num: 4, text: "Cộng số ban đầu: 25 000 + 60 = 25 060", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nhân thừa số vào số ngoài ngoặc trước",
        problem: "Tính giá trị: 48 000 − 8 000 × (24 : 8 + 2)",
        steps: [
          { num: 1, text: "Tính trong ngoặc đơn: 24 : 8 = 3; 3 + 2 = 5", isBug: false },
          { num: 2, text: "Lấy 48 000 − 8 000 = 40 000 trước", isBug: true },
          { num: 3, text: "Lấy 40 000 nhân với 5: 40 000 × 5 = 200 000", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nhân trước chia sau ngoài dấu ngoặc",
        problem: "Tính giá trị của biểu thức: (35 000 + 15 000) : 25 × 4",
        steps: [
          { num: 1, text: "Tính trong ngoặc đơn: 35 000 + 15 000 = 50 000", isBug: false },
          { num: 2, text: "Nhân 25 với 4 trước: 25 × 4 = 100", isBug: true },
          { num: 3, text: "Lấy 50 000 chia cho 100: 50 000 : 100 = 500", isBug: false }
        ],
      ...
      {
        title: "Bẫy Thứ tự ưu tiên trong biểu thức 4 phép tính",
        problem: "Tính giá trị: 120 000 − 40 000 : 8 × 6 + 15 000",
        steps: [
          { num: 1, text: "Thực hiện cụm nhân chia: lấy 8 × 6 = 48", isBug: true },
          { num: 2, text: "Lấy 40 000 chia 48 thấy không chia hết", isBug: false },
          { num: 3, text: "Thấy 40 000 không chia hết cho 48 nên không tìm được giá trị", isBug: false }
        ],
      ...
      {
        title: "Bẫy Bỏ ngoặc khi chia cho một tích",
        problem: "Tính bằng cách thuận tiện: 72 000 : (9 × 8)",
        steps: [
          { num: 1, text: "Bỏ ngoặc đơn: 72 000 : 9 × 8", isBug: true },
          { num: 2, text: "Thực hiện từ trái sang phải: 72 000 : 9 = 8 000", isBug: false },
          { num: 3, text: "Lấy 8 000 × 8 = 64 000", isBug: false }
        ],
      ...
      {
        title: "Bẫy Trừ đi một hiệu có dấu ngoặc",
        problem: "Tính giá trị của biểu thức: 85 000 − (42 000 − 18 000)",
        steps: [
          { num: 1, text: "Bỏ ngoặc giữ nguyên phép trừ: 85 000 − 42 000 − 18 000", isBug: true },
          { num: 2, text: "Lấy 85 000 − 42 000 = 43 000", isBug: false },
          { num: 3, text: "Lấy 43 000 − 18 000 = 25 000", isBug: false }
        ],
      ...
      {
        title: "Bẫy Thực hiện phép trừ trước phép chia",
        problem: "Tính giá trị của biểu thức: 96 000 − 36 000 : 12 + 4 000",
        steps: [
          { num: 1, text: "Thực hiện phép trừ trước: 96 000 − 36 000 = 60 000", isBug: true },
          { num: 2, text: "Lấy 60 000 chia cho 12: 60 000 : 12 = 5 000", isBug: false },
          { num: 3, text: "Cộng thêm 4 000: 5 000 + 4 000 = 9 000", isBug: false }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Mượn nhớ không trả ở hàng chục nghìn",
        problem: "Đặt tính rồi tính hiệu: 475 832 − 198 475",
        steps: [
          { num: 1, text: "Hàng đơn vị: 12 − 5 = 7, viết 7 nhớ 1. Hàng chục: 3 − 8 không được, 13 − 8 = 5, viết 5 nhớ 1", isBug: false },
          { num: 2, text: "Hàng trăm: 8 − 5 = 3, viết 3. Hàng nghìn: 15 − 8 = 7, viết 7 nhớ 1", isBug: false },
          { num: 3, text: "Hàng chục nghìn: 7 mượn 1 thành 17, lấy 17 − 9 = 8, viết 8 (quên trả nhớ 1 vào số trừ)", isBug: true },
          { num: 4, text: "Hàng trăm nghìn: 4 − 1 = 3 (quên bớt 1 đã mượn), viết 3. Ra 387 357", isBug: false }
        ],
      ...
      {
        title: "Bẫy Làm tròn bù trừ trong phép cộng số lớn",
        problem: "Tính nhẩm nhanh tổng: 199 998 + 45 670",
        steps: [
          { num: 1, text: "Làm tròn 199 998 thành 200 000 (mượn thêm 2 đơn vị)", isBug: false },
          { num: 2, text: "Lấy 200 000 + 45 670 = 245 670", isBug: false },
          { num: 3, text: "Vì đã mượn 2 nên ta cộng tiếp 2: 245 670 + 2 = 245 672", isBug: true }
        ],
      ...
      {
        title: "Bẫy Trừ qua 5 chữ số 0 liên tiếp",
        problem: "Đặt tính rồi tính: 1 000 000 − 345 820",
        steps: [
          { num: 1, text: "Hàng đơn vị: 0 − 0 = 0. Hàng chục: 10 − 2 = 8, nhớ 1", isBug: false },
          { num: 2, text: "Hàng trăm: 0 nhớ 1 thành 1, lấy 10 − 9 = 1, nhớ 1", isBug: false },
          { num: 3, text: "Hàng nghìn: coi chữ số 0 nguyên vẹn là 10, lấy 10 − 5 = 5, viết 5", isBug: true },
          { num: 4, text: "Hàng chục nghìn: lấy 9 − 4 = 5. Hàng trăm nghìn: lấy 9 − 3 = 6. Ra kết quả 655 180", isBug: false }
        ],
      ...
      {
        title: "Bẫy Quên số nhớ sang hàng chục nghìn",
        problem: "Đặt tính rồi tính: 567 890 + 284 560",
        steps: [
          { num: 1, text: "Hàng đơn vị: 0 + 0 = 0. Hàng chục: 9 + 6 = 15, viết 5 nhớ 1", isBug: false },
          { num: 2, text: "Hàng trăm: 8 + 5 = 13, thêm 1 bằng 14, viết 4 nhớ 1. Hàng nghìn: 7 + 4 = 11, thêm 1 bằng 12, viết 2 nhớ 1", isBug: false },
          { num: 3, text: "Hàng chục nghìn: 6 + 8 = 14, viết 4 (quên cộng thêm 1 nhớ)", isBug: true },
          { num: 4, text: "Hàng trăm nghìn: 5 + 2 = 7, viết 7. Kết quả ra 742 450", isBug: false }
        ],
      ...
      {
        title: "Bẫy Bù trừ trong phép trừ số lớn",
        problem: "Tính nhẩm nhanh hiệu: 485 000 − 199 000",
        steps: [
          { num: 1, text: "Làm tròn số trừ 199 000 thành 200 000 (trừ nhiều hơn 1 000 đơn vị)", isBug: false },
          { num: 2, text: "Lấy 485 000 − 200 000 = 285 000", isBug: false },
          { num: 3, text: "Vì đã trừ số lớn hơn nên trừ tiếp 1 000: 285 000 − 1 000 = 284 000", isBug: true }
        ],
      ...
      {
        title: "Bẫy Đặt tính lệch cột số khác chữ số",
        problem: "Đặt tính rồi tính: 850 430 − 32 514",
        steps: [
          { num: 1, text: "Đặt chữ số 3 của 32 514 thẳng cột với chữ số 8 của 850 430 (thẳng từ trái sang)", isBug: true },
          { num: 2, text: "Trừ lần lượt từng cột từ phải sang trái", isBug: false },
          { num: 3, text: "Nhận được kết quả hơn 500 000", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tách số để cộng nhẩm số lớn",
        problem: "Tính nhẩm nhanh: 399 990 + 254 600",
        steps: [
          { num: 1, text: "Tách 399 990 = 400 000 − 10", isBug: false },
          { num: 2, text: "Lấy 400 000 + 254 600 = 654 600", isBug: false },
          { num: 3, text: "Lấy 654 600 + 10 = 654 610", isBug: true }
        ],
      ...
      {
        title: "Bẫy Trừ nhẩm tròn chục nghìn",
        problem: "Tính nhẩm nhanh: 750 000 − 498 000",
        steps: [
          { num: 1, text: "Làm tròn 498 000 thành 500 000", isBug: false },
          { num: 2, text: "Lấy 750 000 − 500 000 = 250 000", isBug: false },
          { num: 3, text: "Trừ tiếp phần bù: 250 000 − 2 000 = 248 000", isBug: true }
        ],
      ...
      {
        title: "Bẫy Ghép cặp tính nhanh tính chất kết hợp",
        problem: "Tính nhanh: 125 400 + 384 500 + 74 600 + 115 500",
        steps: [
          { num: 1, text: "Ghép cặp tròn số: (125 400 + 74 600) + (384 500 + 115 500)", isBug: false },
          { num: 2, text: "Tính nhẩm: 125 400 + 74 600 = 200 000", isBug: false },
          { num: 3, text: "Tính nhẩm: 384 500 + 115 500 = 490 000 (nhẩm quên nhớ 1 từ 500 + 500)", isBug: true },
          { num: 4, text: "Cộng lại: 200 000 + 490 000 = 690 000", isBug: false }
        ],
      ...
      {
        title: "Bẫy Mượn ở hàng có chữ số 0 trong phép trừ",
        problem: "Đặt tính rồi tính: 604 050 − 278 090",
        steps: [
          { num: 1, text: "0 − 0 = 0; 15 − 9 = 6 nhớ 1. 0 thêm 1 bằng 1, 10 − 1 = 9 nhớ 1", isBug: false },
          { num: 2, text: "8 thêm 1 bằng 9; 14 − 9 = 5 nhớ 1", isBug: false },
          { num: 3, text: "Hàng chục nghìn: lấy 7 − 0 = 7, viết 7", isBug: true },
          { num: 4, text: "Hàng trăm nghìn: 6 − 2 = 4. Kết luận kết quả là 475 960", isBug: false }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Quên lùi cột tích riêng thứ hai",
        problem: "Đặt tính rồi tính: 2 435 × 24",
        steps: [
          { num: 1, text: "Tích riêng thứ nhất: 2 435 × 4 = 9 740", isBug: false },
          { num: 2, text: "Tích riêng thứ hai: 2 435 × 2 = 4 870, viết thẳng cột dưới 9 740", isBug: true },
          { num: 3, text: "Cộng thẳng hai tích riêng: 9 740 + 4 870 = 14 610", isBug: false }
        ],
      ...
      {
        title: "Bẫy Thừa số có chữ số 0 ở hàng chục",
        problem: "Đặt tính rồi tính: 1 425 × 203",
        steps: [
          { num: 1, text: "Tích riêng thứ nhất: 1 425 × 3 = 4 275", isBug: false },
          { num: 2, text: "Tích riêng thứ hai: 1 425 × 2 = 2 850, viết lùi sang bên trái 1 cột so với tích 1", isBug: true },
          { num: 3, text: "Cộng hai tích riêng lại ra kết quả 32 775", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nhân nhẩm 11 nhớ sang hàng nghìn",
        problem: "Tính nhẩm: 4 875 × 11",
        steps: [
          { num: 1, text: "Viết chữ số hàng đơn vị là 5", isBug: false },
          { num: 2, text: "Cộng từng cặp: 5 + 7 = 12 viết 2 nhớ 1; 7 + 8 = 15 thêm 1 bằng 16 viết 6 nhớ 1", isBug: false },
          { num: 3, text: "4 + 8 = 12 thêm 1 bằng 13, viết 3 nhưng quên cộng 1 nhớ vào chữ số đầu 4", isBug: true },
          { num: 4, text: "Ghi kết quả là 43 625", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nhân phân phối với số 101",
        problem: "Tính nhanh: 485 × 101",
        steps: [
          { num: 1, text: "Tách 101 = 100 + 1", isBug: false },
          { num: 2, text: "Áp dụng tính chất phân phối: 485 × 100 + 1", isBug: true },
          { num: 3, text: "Tính 48 500 + 1 = 48 501", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tách thừa số tính nhanh nhân nhầm phép cộng",
        problem: "Tính nhanh: 125 × 32 × 25",
        steps: [
          { num: 1, text: "Tách 32 = 8 × 4", isBug: false },
          { num: 2, text: "Ghép cặp: (125 × 8) + (4 × 25)", isBug: true },
          { num: 3, text: "Tính 1 000 + 100 = 1 100", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nhân hai tích rồi mới cộng trong bài phân phối",
        problem: "Tính thuận tiện: 245 × 36 + 245 × 64",
        steps: [
          { num: 1, text: "Nhận thấy 245 là thừa số chung, đặt ra ngoài: 245 × (36 + 64)", isBug: false },
          { num: 2, text: "Tính trong ngoặc: 36 + 64 = 100", isBug: false },
          { num: 3, text: "Thực hiện phép nhân: 245 × 100 = 2 450 (quên viết một chữ số 0)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Nhân nhẩm số có 5 chữ số với 5",
        problem: "Tính nhẩm: 24 680 × 5",
        steps: [
          { num: 1, text: "Lấy 24 680 chia cho 2: 24 680 : 2 = 12 340", isBug: false },
          { num: 2, text: "Cộng thêm 10 vào kết quả: 12 340 + 10 = 12 350", isBug: true },
          { num: 3, text: "Kết luận kết quả là 12 350", isBug: false }
        ],
      ...
      {
        title: "Bẫy Quên cộng nhớ khi nhân số 4 chữ số",
        problem: "Đặt tính rồi tính: 3 516 × 42",
        steps: [
          { num: 1, text: "Tích riêng 1: 3 516 × 2 = 7 032", isBug: false },
          { num: 2, text: "Tích riêng 2: 4 × 6 = 24 viết 4 nhớ 2; 4 × 1 = 4 (quên cộng 2 nhớ) viết 4", isBug: true },
          { num: 3, text: "4 × 5 = 20 viết 0 nhớ 2; 4 × 3 = 12 thêm 2 là 14. Ra tích 2 là 140 440", isBug: false },
          { num: 4, text: "Cộng hai tích riêng: 7 032 + 140 440 = 147 472", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tách thừa số nhân với 125",
        problem: "Tính nhanh: 48 × 125",
        steps: [
          { num: 1, text: "Tách 48 = 6 × 8", isBug: false },
          { num: 2, text: "Nhân kết hợp: 6 × (8 × 125) = 6 × 1 000", isBug: false },
          { num: 3, text: "Lấy 6 + 1 000 = 1 006", isBug: true }
        ],
      ...
      {
        title: "Bẫy Nhân một số với 99",
        problem: "Tính nhanh: 350 × 99",
        steps: [
          { num: 1, text: "Tách 99 = 100 − 1", isBug: false },
          { num: 2, text: "Áp dụng phân phối: 350 × 100 − 99", isBug: true },
          { num: 3, text: "Tính: 35 000 − 99 = 34 901", isBug: false }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Quên chữ số 0 ở giữa thương khi chia số có 5 chữ số",
        problem: "Đặt tính rồi tính phép chia: 35 280 : 35",
        steps: [
          { num: 1, text: "Lấy 35 chia 35 được 1, viết 1; 1 × 35 = 35; 35 − 35 = 0", isBug: false },
          { num: 2, text: "Hạ 2, vì 2 không chia được 35 nên hạ tiếp 8 được 28; vẫn không chia được nên hạ 0 được 280; 280 : 35 = 8", isBug: true },
          { num: 3, text: "Ghi thương là 18. Kết luận: 35 280 : 35 = 18", isBug: false }
        ],
      ...
      {
        title: "Bẫy Quên số 0 ở hàng chục của thương khi chia cho số 2 chữ số",
        problem: "Đặt tính rồi tính: 84 168 : 42",
        steps: [
          { num: 1, text: "84 : 42 = 2, viết 2; 2 × 42 = 84; 84 − 84 = 0", isBug: false },
          { num: 2, text: "Hạ 1 không chia được cho 42, hạ tiếp 6 được 16; vẫn không chia được nên hạ tiếp 8 được 168; 168 : 42 = 4, viết 4", isBug: true },
          { num: 3, text: "Ghi thương là 24", isBug: false }
        ],
      ...
      {
        title: "Bẫy Số dư lớn hơn hoặc bằng số chia",
        problem: "Thực hiện phép chia: 45 890 : 45",
        steps: [
          { num: 1, text: "45 : 45 = 1 viết 1; hạ 8 chia 45 được 0 viết 0; hạ 9 được 89", isBug: false },
          { num: 2, text: "89 : 45 ước lượng được 1, viết 1; 89 − 45 = 44; hạ 0 được 440", isBug: false },
          { num: 3, text: "Ước lượng 440 : 45 được 8; 8 × 45 = 360; 440 − 360 = 80. Kết luận thương 1018 dư 80", isBug: true }
        ],
      ...
      {
        title: "Bẫy Xác định số dư sau khi cùng bớt số 0 tận cùng",
        problem: "Thực hiện phép chia có dư: 28 500 : 400",
        steps: [
          { num: 1, text: "Cùng gạch bỏ hai chữ số 0 tận cùng ở cả số bị chia và số chia: 285 : 4", isBug: false },
          { num: 2, text: "Thực hiện chia: 285 : 4 = 71 dư 1", isBug: false },
          { num: 3, text: "Kết luận phép chia ban đầu có thương là 71 và số dư là 1", isBug: true }
        ],
      ...
      {
        title: "Bẫy Quên chữ số 0 ở thương khi chia số tròn chục",
        problem: "Đặt tính rồi tính: 125 450 : 25",
        steps: [
          { num: 1, text: "125 : 25 = 5, viết 5; 5 × 25 = 125; 125 − 125 = 0", isBug: false },
          { num: 2, text: "Hạ 4, vì 4 < 25 nên hạ tiếp 5 được 45; 45 : 25 = 1 dư 20", isBug: true },
          { num: 3, text: "Hạ 0 được 200; 200 : 25 = 8, viết 8", isBug: false },
          { num: 4, text: "Ghi thương là 518", isBug: false }
        ],
      ...
      {
        title: "Bẫy Gạch số 0 không đều nhau ở hai vế chia",
        problem: "Tính giá trị của phép chia: 720 000 : 8 000",
        steps: [
          { num: 1, text: "Gạch bỏ cả 4 chữ số 0 ở 720 000 và 3 chữ số 0 ở 8 000", isBug: true },
          { num: 2, text: "Được phép tính 72 : 8 = 9", isBug: false },
          { num: 3, text: "Kết luận thương là 9", isBug: false }
        ],
      ...
      {
        title: "Bẫy Kiểm tra phép chia có dư",
        problem: "Kiểm tra xem phép tính sau đúng hay sai: 1 485 : 24 = 61 dư 21",
        steps: [
          { num: 1, text: "Nhận xét số dư 21 < 24 là hợp lệ", isBug: false },
          { num: 2, text: "Kiểm tra lại bằng cách lấy: 61 × 24 − 21", isBug: true },
          { num: 3, text: "Thấy ra 1 443 khác 1 485 nên kết luận phép chia sai", isBug: false }
        ],
      ...
      {
        title: "Bẫy Quên hai chữ số 0 ở thương khi chia số 5 chữ số",
        problem: "Tính: 61 224 : 6",
        steps: [
          { num: 1, text: "6 : 6 = 1, viết 1", isBug: false },
          { num: 2, text: "Hạ 1 không chia được nên hạ tiếp 2 được 12; 12 : 6 = 2, viết 2", isBug: true },
          { num: 3, text: "Hạ 2 không chia được hạ tiếp 4 được 24; 24 : 6 = 4, viết 4", isBug: false },
          { num: 4, text: "Ghi thương là 124", isBug: false }
        ],
      ...
      {
        title: "Bẫy Quên chữ số 0 tận cùng của thương",
        problem: "Đặt tính rồi tính: 48 360 : 12",
        steps: [
          { num: 1, text: "48 : 12 = 4, viết 4; 4 × 12 = 48; 48 − 48 = 0", isBug: false },
          { num: 2, text: "Hạ 3 chia 12 được 0, viết 0; hạ 6 được 36; 36 : 12 = 3, viết 3", isBug: false },
          { num: 3, text: "Chữ số 0 cuối cùng không chia được nên bỏ qua, ghi thương là 403", isBug: true }
        ],
      ...
      {
        title: "Bẫy Rút gọn số 0 rồi cộng sai số dư",
        ...
        steps: [
          { num: 1, text: "Cùng bớt một chữ số 0: 345 : 5", isBug: false },
          { num: 2, text: "345 : 5 = 69 dư 0", isBug: false },
          { num: 3, text: "Kết luận vì ban đầu có số 0 nên số dư là 10 quyển", isBug: true }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Tính chất phân phối trong bài toán tìm x",
        problem: "Tìm x, biết: x × 38 + x × 62 = 45 000",
        steps: [
          { num: 1, text: "Đặt thừa số x ra ngoài: x × (38 + 62) = 45 000", isBug: false },
          { num: 2, text: "Tính tổng trong ngoặc: x × 100 = 45 000", isBug: false },
          { num: 3, text: "Muốn tìm thừa số x, ta lấy: x = 45 000 × 100 = 4 500 000", isBug: true }
        ],
      ...
      {
        title: "Bẫy Tìm số bị chia trong phương trình có ngoặc",
        problem: "Tìm x, biết: (x − 3 450) : 25 = 140",
        steps: [
          { num: 1, text: "Cụm (x − 3 450) đóng vai trò là số bị chia: x − 3 450 = 140 × 25", isBug: false },
          { num: 2, text: "Tính 140 × 25 = 3 500", isBug: false },
          { num: 3, text: "Tìm số bị trừ x: x = 3 500 − 3 450 = 50", isBug: true }
        ],
      ...
      {
        title: "Bẫy Tìm số trừ là một tích",
        problem: "Tìm x, biết: 18 500 − x × 35 = 2 400",
        steps: [
          { num: 1, text: "Coi cụm (x × 35) là số trừ: x × 35 = 18 500 − 2 400", isBug: false },
          { num: 2, text: "Tính hiệu: x × 35 = 16 100", isBug: false },
          { num: 3, text: "Tìm x: x = 16 100 × 35", isBug: true }
        ],
      ...
      {
        title: "Bẫy Thứ tự tìm x trong biểu thức chia và cộng",
        problem: "Tìm x, biết: x : 45 + 2 150 = 3 200",
        steps: [
          { num: 1, text: "Lấy 45 + 2 150 trước, biến đổi thành x : 2 195 = 3 200", isBug: true },
          { num: 2, text: "Tìm x = 3 200 × 2 195", isBug: false },
          { num: 3, text: "Tính ra x = 7 024 000 (kết quả tăng vọt)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Dấu trong phép tính trừ hai tích có x",
        problem: "Tìm x, biết: x × 125 − x × 25 = 45 000",
        steps: [
          { num: 1, text: "Đặt thừa số x ra ngoài: x × (125 + 25) = 45 000", isBug: true },
          { num: 2, text: "Tính trong ngoặc: x × 150 = 45 000", isBug: false },
          { num: 3, text: "Tìm x = 45 000 : 150 = 300", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tìm số chia có chứa ẩn x",
        problem: "Tìm x, biết: 14 400 : (x × 6) = 40",
        steps: [
          { num: 1, text: "Cụm (x × 6) là số chia: x × 6 = 14 400 : 40", isBug: false },
          { num: 2, text: "Tính 14 400 : 40 = 360", isBug: false },
          { num: 3, text: "Tìm x: x = 360 × 6 = 2 160", isBug: true }
        ],
        bugExplanation: "x × 6 = 360 thì x là thừa số chưa biết! Phải lấy 360 : 6 = 60, không phải nhân 6!",
        correctSolution: "x × 6 = 360 → x = 360 : 6 = 60"
      },
      {
        title: "Bẫy Tìm số bị chia trong phép chia có dư",
        problem: "Tìm số tự nhiên x, biết: x : 18 = 240 (dư 15)",
        steps: [
          { num: 1, text: "Muốn tìm số bị chia x, ta lấy: x = 240 × 18 − 15", isBug: true },
          { num: 2, text: "Tính 240 × 18 = 4 320", isBug: false },
          { num: 3, text: "Lấy 4 320 − 15 = 4 305", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nhân phân phối ngoài ngoặc khi tìm x",
        problem: "Tìm x, biết: (x + 5 200) × 12 = 144 000",
        steps: [
          { num: 1, text: "Cụm (x + 5 200) là thừa số chưa biết: x + 5 200 = 144 000 : 12", isBug: false },
          { num: 2, text: "Tính: 144 000 : 12 = 12 000", isBug: false },
          { num: 3, text: "Tìm số hạng x: x = 12 000 + 5 200 = 17 200", isBug: true }
        ],
      ...
      {
        title: "Bẫy Quên số hạng x là x × 1 khi đặt thừa số chung",
        problem: "Tìm x, biết: x × 48 + x × 51 + x = 32 000",
        steps: [
          { num: 1, text: "Đặt thừa số chung: x × (48 + 51) = 32 000", isBug: true },
          { num: 2, text: "Tính: x × 99 = 32 000", isBug: false },
          { num: 3, text: "Thấy 32 000 không chia hết cho 99", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tìm số chia x trong bài toán hai tầng",
        problem: "Tìm x, biết: 85 000 − 72 000 : x = 82 600",
        steps: [
          { num: 1, text: "Cụm (72 000 : x) là số trừ: 72 000 : x = 85 000 − 82 600", isBug: false },
          { num: 2, text: "Tính hiệu: 72 000 : x = 2 400", isBug: false },
          { num: 3, text: "Tìm số chia x: x = 72 000 × 2 400", isBug: true }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Trung bình cộng của 4 xe chở hàng khối lượng lớn",
        ...
        steps: [
          { num: 1, text: "Tính tổng khối lượng 4 xe chở: 4 500 + 4 800 + 5 200 + 4 700 = 19 200 (kg)", isBug: false },
          { num: 2, text: "Trung bình mỗi xe chở là: 19 200 : 3 = 6 400 (kg)", isBug: true },
          { num: 3, text: "Đáp số: 6 400 kg", isBug: false }
        ],
      ...
      {
        title: "Bẫy Trung bình cộng hai nhóm xe không đều nhau",
        ...
        steps: [
          { num: 1, text: "Tính tổng số xe của cả đội: 3 + 2 = 5 (xe)", isBug: false },
          { num: 2, text: "Lấy trung bình cộng số gạo của 1 xe lớn và 1 xe nhỏ: (3 500 + 2 000) : 2 = 2 750 (kg)", isBug: true },
          { num: 3, text: "Kết luận trung bình mỗi xe chở 2 750 kg gạo", isBug: false }
        ],
      ...
      {
        title: "Bẫy Bài toán nhiều hơn mức trung bình cộng cả 4 bạn",
        ...
        steps: [
          { num: 1, text: "Tính trung bình cộng số bi của 3 bạn: (45 + 35 + 40) : 3 = 40 (viên)", isBug: false },
          { num: 2, text: "Số bi của Bách là: 40 + 6 = 46 (viên)", isBug: true },
          { num: 3, text: "Đáp số: 46 viên bi", isBug: false }
        ],
      ...
      {
        title: "Bẫy Trung bình cộng của 5 số lẻ liên tiếp",
        problem: "Trung bình cộng của 5 số lẻ liên tiếp là 2 025. Tìm số lớn nhất trong 5 số đó.",
        steps: [
          { num: 1, text: "Vì có 5 số lẻ liên tiếp nên số ở chính giữa (số thứ ba) chính là trung bình cộng: 2 025", isBug: false },
          { num: 2, text: "Hai số lẻ liên tiếp hơn kém nhau 1 đơn vị", isBug: true },
          { num: 3, text: "Số lớn nhất (số thứ năm) là: 2 025 + 2 = 2 027", isBug: false }
        ],
      ...
      {
        title: "Bẫy Ít hơn trung bình cộng cả 3 lớp",
        ...
        steps: [
          { num: 1, text: "Tổng số cây lớp 4A và 4B: 180 + 220 = 400 (cây)", isBug: false },
          { num: 2, text: "Trung bình cộng của cả 3 lớp là: (400 + 20) : 2 = 210 (cây)", isBug: true },
          { num: 3, text: "Lớp 4C trồng được: 210 − 20 = 190 (cây)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tìm số điểm bài thi để nâng điểm trung bình",
        ...
        steps: [
          { num: 1, text: "Tổng số điểm của 4 bài kiểm tra đầu là: 9 × 4 = 36 (điểm)", isBug: false },
          { num: 2, text: "Tổng số điểm của cả 5 bài kiểm tra cần đạt là: 46 điểm", isBug: false },
          { num: 3, text: "Điểm bài thứ năm cần đạt: 46 − 36 = 10 điểm (nhưng ghi nhầm thành 9 điểm)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Trung bình cộng không đổi khi chuyển nội bộ",
        ...
        steps: [
          { num: 1, text: "Tổng số tấn thóc ban đầu của 3 kho là: 45 × 3 = 135 (tấn)", isBug: false },
          { num: 2, text: "Kho A giảm 5 tấn nên coi tổng số thóc của 3 kho giảm 5 tấn thành 130 tấn", isBug: true },
          { num: 3, text: "Trung bình mỗi kho giảm đi: 5 : 3 tấn", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nhầm trung bình cộng là tổng của hai số",
        problem: "Trung bình cộng của hai số là 1 450, biết số lớn hơn số bé 300 đơn vị. Tìm số lớn.",
        steps: [
          { num: 1, text: "Coi 1 450 là tổng của hai số", isBug: true },
          { num: 2, text: "Số lớn là: (1 450 + 300) : 2 = 875", isBug: false },
          { num: 3, text: "Đáp số: 875", isBug: false }
        ],
      ...
      {
        title: "Bẫy Trung bình cộng của 5 tổ sản xuất",
        ...
        steps: [
          { num: 1, text: "Tính tổng sản phẩm 3 tổ đầu: 1 200 × 3 = 3 600 (sản phẩm)", isBug: false },
          { num: 2, text: "Tính tổng sản phẩm 2 tổ sau: 1 450 × 2 = 2 900 (sản phẩm)", isBug: false },
          { num: 3, text: "Tổng sản phẩm cả 5 tổ: 3 600 + 2 900 = 6 500 (sản phẩm)", isBug: false },
          { num: 4, text: "Trung bình mỗi tổ sản xuất: 6 500 : 2 = 3 250 (sản phẩm)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Tuổi cô giáo và cả lớp học",
        ...
        steps: [
          { num: 1, text: "Tổng số người gồm cô giáo và 30 học sinh là: 30 + 1 = 31 (người)", isBug: false },
          { num: 2, text: "Tổng số tuổi của cô và cả lớp: 11 × 31 = 341 (tuổi)", isBug: false },
          { num: 3, text: "Tổng số tuổi của 30 học sinh: 10 × 30 = 300 (tuổi)", isBug: false },
          { num: 4, text: "Tuổi cô giáo là: 341 − 300 = 31 (tuổi) (ghi nhầm phép tính thành 341 : 11 = 31)", isBug: true }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Công thức tìm số bé trong bài toán hai kho thóc",
        problem: "Hai kho thóc chứa tất cả 145 tấn thóc. Kho A chứa nhiều hơn kho B là 25 tấn. Tính số thóc ở kho B (số bé).",
        steps: [
          { num: 1, text: "Áp dụng công thức tìm số bé: Số bé = (Tổng + Hiệu) : 2", isBug: true },
          { num: 2, text: "Tính: (145 + 25) : 2 = 170 : 2 = 85 (tấn)", isBug: false },
          { num: 3, text: "Kết luận kho B có 85 tấn thóc", isBug: false }
        ],
      ...
      {
        title: "Bẫy Lấy chu vi làm tổng trong bài toán khu đất",
        problem: "Một khu đất hình chữ nhật có chu vi 360m, chiều dài hơn chiều rộng 40m. Tìm chiều rộng khu đất.",
        steps: [
          { num: 1, text: "Tổng chiều dài và chiều rộng là: 360m", isBug: true },
          { num: 2, text: "Chiều rộng là: (360 − 40) : 2 = 160 (m)", isBug: false },
          { num: 3, text: "Chiều dài là: 160 + 40 = 200 (m)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Hiệu hai số chẵn liên tiếp",
        problem: "Hai số chẵn liên tiếp có tổng bằng 2 454. Tìm số lớn.",
        steps: [
          { num: 1, text: "Vì là hai số liên tiếp nên hiệu hai số là: 1 đơn vị", isBug: true },
          { num: 2, text: "Số lớn là: (2 454 + 1) : 2 (không chia hết cho 2)", isBug: false },
          { num: 3, text: "Thấy (2 454 + 1) : 2 = 1 227.5 là số thập phân nên không tìm được", isBug: false }
        ],
      ...
      {
        title: "Bẫy Đếm khoảng cách số chẵn ở giữa hai số tự nhiên",
        problem: "Hai số tự nhiên có tổng bằng 3 500, biết giữa chúng có đúng 14 số chẵn khác. Tìm số lớn.",
        steps: [
          { num: 1, text: "Giữa hai số có 14 số chẵn nên hiệu giữa hai số là: 14 đơn vị", isBug: true },
          { num: 2, text: "Tính số lớn: (3 500 + 14) : 2 = 1 757", isBug: false },
          { num: 3, text: "Đáp số: 1 757", isBug: false }
        ],
      ...
      {
        title: "Bẫy Hiệu số tuổi thay đổi theo thời gian",
        ...
        steps: [
          { num: 1, text: "5 năm trước bố hơn con 28 tuổi, nên hiện nay bố hơn con: 28 + 5 = 33 (tuổi)", isBug: true },
          { num: 2, text: "Tuổi bố hiện nay là: (50 + 33) : 2 (ra số thập phân)", isBug: false },
          { num: 3, text: "Thấy ra 41.5 tuổi là số lẻ thập phân nên lúng túng", isBug: false }
        ],
      ...
      {
        title: "Bẫy Chuyển đồ từ thùng nọ sang thùng kia làm thay đổi hiệu",
        ...
        steps: [
          { num: 1, text: "Vì chuyển 15 lít thì bằng nhau nên ban đầu thùng 1 hơn thùng 2 đúng 15 lít", isBug: true },
          { num: 2, text: "Thùng 1 ban đầu có: (180 + 15) : 2 = 97.5 (lít)", isBug: false },
          { num: 3, text: "Ghi kết quả thùng 1 có 97.5 lít và thùng 2 có 82.5 lít", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tổng - Hiệu của 3 đối tượng",
        ...
        steps: [
          { num: 1, text: "Lấy kho B làm chuẩn: Kho A = B − 200, Kho C = B + 400", isBug: false },
          { num: 2, text: "Ba lần số thóc kho B là: 3 600 − 200 + 400 = 3 800 (tấn)", isBug: true },
          { num: 3, text: "Số thóc kho B là: 3 800 : 3 (không chia hết)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Bớt số lớn để bằng số bé",
        problem: "Hai số tự nhiên có tổng bằng 1 450. Nếu bớt số lớn đi 150 đơn vị thì được số bé. Tìm số bé.",
        steps: [
          { num: 1, text: "Bớt số lớn đi 150 đơn vị thì bằng số bé, nên hiệu hai số là: 150 × 2 = 300", isBug: true },
          { num: 2, text: "Số bé là: (1 450 − 300) : 2 = 575", isBug: false },
          { num: 3, text: "Đáp số: 575", isBug: false }
        ],
      ...
      {
        title: "Bẫy Hai lớp quyên góp vở Tổng - Hiệu",
        ...
        steps: [
          { num: 1, text: "Lớp 4A thêm 30 quyển mới bằng 4B, nên lớp 4B nhiều hơn 4A là 30 quyển (4B là số lớn)", isBug: false },
          { num: 2, text: "Số vở lớp 4B là: (450 − 30) : 2 = 210 (quyển)", isBug: true },
          { num: 3, text: "Đáp số: 210 quyển", isBug: false }
        ],
      ...
      {
        title: "Bẫy Nửa chu vi cho sẵn trong bài toán sân trường",
        problem: "Một sân trường hình chữ nhật có nửa chu vi là 140m, chiều dài hơn chiều rộng 20m. Tính diện tích sân trường.",
        steps: [
          { num: 1, text: "Tính nửa chu vi: lấy 140 : 2 = 70 (m)", isBug: true },
          { num: 2, text: "Chiều dài là: (70 + 20) : 2 = 45 (m)", isBug: false },
          { num: 3, text: "Chiều rộng là: 45 − 20 = 25 (m)", isBug: false },
          { num: 4, text: "Diện tích: 45 × 25 = 1 125 (m²)", isBug: false }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Tìm nhầm số phần của từng đối tượng trong bài trang trại",
        problem: "Một trang trại nuôi 1 200 con gà và vịt. Biết số gà bằng 3/5 số vịt. Hỏi trang trại đó nuôi bao nhiêu con gà?",
        steps: [
          { num: 1, text: "Tổng số phần bằng nhau là: 3 + 5 = 8 (phần)", isBug: false },
          { num: 2, text: "Giá trị của 1 phần là: 1 200 : 8 = 150 (con)", isBug: false },
          { num: 3, text: "Số gà là: 150 × 5 = 750 (con)", isBug: true },
          { num: 4, text: "Đáp số: 750 con gà", isBug: false }
        ],
      ...
      {
        title: "Bẫy Lấy cả chu vi chia cho tổng số phần",
        problem: "Một thửa ruộng hình chữ nhật có chu vi 280m, chiều rộng bằng 3/4 chiều dài. Tính diện tích thửa ruộng.",
        steps: [
          { num: 1, text: "Tổng số phần bằng nhau: 3 + 4 = 7 (phần)", isBug: false },
          { num: 2, text: "Chiều rộng là: 280 : 7 × 3 = 120 (m)", isBug: true },
          { num: 3, text: "Chiều dài là: 280 : 7 × 4 = 160 (m)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tính tổng số phần trong bài toán Hiệu - Tỉ",
        ...
        steps: [
          { num: 1, text: "Tổng số phần bằng nhau: 3 + 7 = 10 (phần)", isBug: true },
          { num: 2, text: "Giá trị 1 phần: 240 : 10 = 24 (tấn)", isBug: false },
          { num: 3, text: "Kho thứ nhất: 24 × 7 = 168 (tấn)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Hiệu số tuổi sau nhiều năm trong bài toán tỉ số",
        problem: "Hiện nay mẹ hơn con 24 tuổi. Sau 3 năm nữa, tuổi con bằng 1/3 tuổi mẹ. Tính tuổi con hiện nay.",
        steps: [
          { num: 1, text: "Sau 3 năm nữa mẹ hơn con: 24 + 3 = 27 (tuổi)", isBug: true },
          { num: 2, text: "Hiệu số phần: 3 − 1 = 2 (phần)", isBug: false },
          { num: 3, text: "Tuổi con sau 3 năm: 27 : 2 (không chia hết)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tỉ số của 3 đại lượng",
        ...
        steps: [
          { num: 1, text: "Coi thùng 1 là 1 phần thì thùng 2 là 2 phần và thùng 3 là 3 phần", isBug: false },
          { num: 2, text: "Tổng số phần bằng nhau là: 1 + 2 + 3 = 6 (phần)", isBug: false },
          { num: 3, text: "Số dầu thùng 3 là: 1 800 : 6 × 1 = 300 (lít)", isBug: true },
          { num: 4, text: "Đáp số: 300 lít", isBug: false }
        ],
      ...
      {
        title: "Bẫy Xác định giá trị một phần khi thêm số lượng",
        ...
        steps: [
          { num: 1, text: "Nam có 3 phần, nữ có 4 phần", isBug: false },
          { num: 2, text: "Hiệu số phần: 4 − 3 = 1 (phần)", isBug: false },
          { num: 3, text: "Thêm 4 nam thì bằng nữ, chứng tỏ 1 phần tương ứng với: 4 : 2 = 2 (bạn)", isBug: true },
          { num: 4, text: "Số bạn nữ là: 2 × 4 = 8 (bạn)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Bài toán Hiệu - Tỉ có phép chia có dư",
        problem: "Hai số tự nhiên có hiệu là 180. Biết số lớn chia cho số bé được thương là 4 dư 15. Tìm số bé.",
        steps: [
          { num: 1, text: "Số lớn bằng 4 lần số bé cộng 15", isBug: false },
          { num: 2, text: "Hiệu số phần là: 4 − 1 = 3 (phần)", isBug: false },
          { num: 3, text: "3 lần số bé là: 180 + 15 = 195", isBug: true },
          { num: 4, text: "Số bé là: 195 : 3 = 65", isBug: false }
        ],
      ...
      {
        title: "Bẫy Chuyển đổi trạng thái trước khi tính tỉ số",
        ...
        steps: [
          { num: 1, text: "Tổng số dầu hai thùng không đổi là 250 lít", isBug: false },
          { num: 2, text: "Lúc sau thùng A có: 250 : (2 + 3) × 2 = 100 (lít)", isBug: false },
          { num: 3, text: "Ban đầu thùng A có: 100 − 25 = 75 (lít)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Tỉ số sách giáo khoa và truyện",
        problem: "Tủ sách có 480 quyển gồm SGK và truyện tranh. Số truyện tranh bằng 3/5 số SGK. Tìm số truyện tranh.",
        steps: [
          { num: 1, text: "Tổng số phần: 3 + 5 = 8 (phần)", isBug: false },
          { num: 2, text: "Giá trị 1 phần: 480 : 8 = 60 (quyển)", isBug: false },
          { num: 3, text: "Số truyện tranh là: 60 × 5 = 300 (quyển)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Tìm tỉ số khi đại lượng thứ hai giảm",
        ...
        steps: [
          { num: 1, text: "Quy đồng số trâu không đổi: 2/5 số bò ban đầu = 2/4 số bò lúc sau", isBug: false },
          { num: 2, text: "Bò ban đầu là 5 phần, bò lúc sau là 4 phần", isBug: false },
          { num: 3, text: "1 phần tương ứng 15 con bò", isBug: false },
          { num: 4, text: "Số trâu là: 15 × 5 = 75 (con)", isBug: true }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Đổi đơn vị diện tích m² sang dm²",
        problem: "Một phòng học hình chữ nhật có diện tích 72 m². Hỏi diện tích đó bằng bao nhiêu dm²?",
        steps: [
          { num: 1, text: "Nhận xét quan hệ: 1 m = 10 dm", isBug: false },
          { num: 2, text: "Do đó 72 m² = 72 × 10 = 720 dm²", isBug: true },
          { num: 3, text: "Đáp số: 720 dm²", isBug: false }
        ],
      ...
      {
        title: "Bẫy Viết thiếu số 0 khi đổi đơn vị kép m² và dm²",
        problem: "Đổi đơn vị đo: 15 m² 8 dm² sang đề-xi-mét vuông (dm²).",
        steps: [
          { num: 1, text: "15 m² = 1 500 dm²", isBug: false },
          { num: 2, text: "Viết ghép hai số: 15 m² 8 dm² = 158 dm²", isBug: true },
          { num: 3, text: "Đáp số: 158 dm²", isBug: false }
        ],
      ...
      {
        title: "Bẫy Công thức diện tích hình bình hành",
        ...
        steps: [
          { num: 1, text: "Xác định các kích thước: Đáy a = 36m, Chiều cao h = 18m, Cạnh bên b = 24m", isBug: false },
          { num: 2, text: "Áp dụng công thức: Diện tích = Đáy × Cạnh bên = 36 × 24 = 864 (m²)", isBug: true },
          { num: 3, text: "Đáp số: 864 m²", isBug: false }
        ],
      ...
      {
        title: "Bẫy Quên chia 2 khi tính diện tích hình thoi",
        problem: "Một tấm kính hình thoi có độ dài hai đường chéo lần lượt là 40cm và 30cm. Tính diện tích tấm kính đó.",
        steps: [
          { num: 1, text: "Xác định độ dài hai đường chéo: m = 40cm, n = 30cm", isBug: false },
          { num: 2, text: "Diện tích hình thoi = Tích độ dài hai đường chéo = 40 × 30 = 1 200 (cm²)", isBug: true },
          { num: 3, text: "Đáp số: 1 200 cm²", isBug: false }
        ],
      ...
      {
        title: "Bẫy Khác đơn vị đo khi tính số gạch lát sàn",
        ...
        steps: [
          { num: 1, text: "Diện tích căn phòng: 8 × 6 = 48 (m²)", isBug: false },
          { num: 2, text: "Diện tích 1 viên gạch: 4 × 4 = 16 (dm²)", isBug: false },
          { num: 3, text: "Số viên gạch cần mua: 48 : 16 = 3 (viên)", isBug: true },
          { num: 4, text: "Đáp số: 3 viên gạch", isBug: false }
        ],
      ...
      {
        title: "Bẫy Cạnh hình vuông gấp lên nhiều lần thì diện tích gấp mấy lần",
        problem: "Khi cạnh của một hình vuông tăng lên gấp 3 lần thì diện tích của hình vuông đó tăng lên gấp bao nhiêu lần?",
        steps: [
          { num: 1, text: "Công thức diện tích hình vuông: S = a × a", isBug: false },
          { num: 2, text: "Vì cạnh a tăng gấp 3 lần nên diện tích tăng gấp 3 lần", isBug: true },
          { num: 3, text: "Kết luận diện tích tăng gấp 3 lần", isBug: false }
        ],
      ...
      {
        title: "Bẫy Đổi đơn vị đo khối lượng tấn, tạ, yến",
        problem: "Đổi 4 tấn 5 tạ 60 kg sang ki-lô-gam (kg).",
        steps: [
          { num: 1, text: "4 tấn = 4 000 kg", isBug: false },
          { num: 2, text: "5 tạ = 50 kg", isBug: true },
          { num: 3, text: "Cộng lại: 4 000 + 50 + 60 = 4 110 kg", isBug: false }
        ],
      ...
      {
        title: "Bẫy Xác định năm thuộc thế kỷ",
        problem: "Năm 2000 và năm 2001 lần lượt thuộc thế kỷ nào?",
        steps: [
          { num: 1, text: "Năm 2000 là năm cuối cùng của thế kỷ XX (20)", isBug: false },
          { num: 2, text: "Năm 2001 cũng thuộc thế kỷ XX vì chỉ hơn 1 năm", isBug: true },
          { num: 3, text: "Kết luận cả hai năm đều thuộc thế kỷ XX", isBug: false }
        ],
      ...
      {
        title: "Bẫy Đổi km² sang m²",
        problem: "Một khu bảo tồn thiên nhiên có diện tích 5 km² 450 m². Đổi diện tích đó sang m².",
        steps: [
          { num: 1, text: "1 km = 1 000 m nên 1 km² = 1 000 000 m²", isBug: false },
          { num: 2, text: "5 km² = 5 000 000 m²", isBug: false },
          { num: 3, text: "Ghép vào: 5 000 000 + 450 = 5 004 500 m²", isBug: true }
        ],
      ...
      {
        title: "Bẫy Tìm chu vi khi biết diện tích hình chữ nhật",
        problem: "Một hình chữ nhật có diện tích 360 cm², chiều rộng là 12 cm. Tính chu vi hình chữ nhật đó.",
        steps: [
          { num: 1, text: "Chiều dài hình chữ nhật là: 360 : 12 = 30 (cm)", isBug: false },
          { num: 2, text: "Chu vi hình chữ nhật là: 30 + 12 = 42 (cm)", isBug: true },
          { num: 3, text: "Đáp số: 42 cm", isBug: false }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Cộng tử với tử, mẫu với mẫu",
        problem: "Thực hiện phép tính cộng hai phân số: 5/12 + 7/18",
        steps: [
          { num: 1, text: "Cộng các tử số với nhau: 5 + 7 = 12", isBug: false },
          { num: 2, text: "Cộng các mẫu số với nhau: 12 + 18 = 30", isBug: true },
          { num: 3, text: "Được phân số 12/30, rút gọn thành 2/5", isBug: false }
        ],
      ...
      {
        title: "Bẫy Trừ mẫu cho mẫu khi trừ hai phân số",
        problem: "Thực hiện phép trừ: 7/8 − 5/12",
        steps: [
          { num: 1, text: "Lấy tử trừ tử: 7 − 5 = 2; lấy mẫu trừ mẫu: 12 − 8 = 4", isBug: true },
          { num: 2, text: "Được phân số 2/4 = 1/2", isBug: false },
          { num: 3, text: "Kết luận: 1/2", isBug: false }
        ],
      ...
      {
        title: "Bẫy Rút gọn phân số chia không cùng một số",
        problem: "Rút gọn phân số: 72/108",
        steps: [
          { num: 1, text: "Chia tử số cho 8: 72 : 8 = 9", isBug: false },
          { num: 2, text: "Chia mẫu số cho 9: 108 : 9 = 12", isBug: true },
          { num: 3, text: "Được phân số 9/12, rút gọn tiếp thành 3/4", isBug: false }
        ],
      ...
      {
        title: "Bẫy So sánh hai phân số bằng phần bù tới 1",
        problem: "So sánh hai phân số: 2 023/2 024 và 2 024/2 025",
        steps: [
          { num: 1, text: "Phần bù tới 1 của 2 023/2 024 là: 1 − 2 023/2 024 = 1/2 024", isBug: false },
          { num: 2, text: "Phần bù tới 1 của 2 024/2 025 là: 1 − 2 024/2 025 = 1/2 025", isBug: false },
          { num: 3, text: "Vì 1/2 024 > 1/2 025 nên kết luận 2 023/2 024 > 2 024/2 025", isBug: true }
        ],
      ...
      {
        title: "Bẫy Rút gọn chéo trước khi nhân hai phân số",
        problem: "Tính tích: 15/16 × 24/25",
        steps: [
          { num: 1, text: "Nhân trực tiếp: tử số = 15 × 24 = 360, mẫu số = 16 × 25 = 400", isBug: false },
          { num: 2, text: "Rút gọn 360/400 bằng cách chia cho 40: 360 : 40 = 9; 400 : 40 = 10", isBug: false },
          { num: 3, text: "Nếu rút gọn chéo từ đầu: 15 và 25 chia 5 được 3 và 5; 24 và 16 chia 8 được 3 và 2. Tích = (3 × 3)/(2 × 5) = 8/10", isBug: true }
        ],
        bugExplanation: "3 × 3 = 9, không phải 8! Kết quả chuẩn phải là (3 × 3)/(2 × 5) = 9/10!",
        correctSolution: "15/16 × 24/25 = (3 × 3)/(2 × 5) = 9/10"
      },
      {
        title: "Bẫy Đảo ngược nhầm phân số thứ nhất khi chia",
        problem: "Tính giá trị của phép chia hai phân số: 9/14 : 6/35",
        steps: [
          { num: 1, text: "Chuyển phép chia thành phép nhân với phân số đảo ngược", isBug: false },
          { num: 2, text: "Đảo ngược phân số thứ nhất thành 14/9 và giữ nguyên phân số thứ hai: 14/9 × 6/35", isBug: true },
          { num: 3, text: "Rút gọn chéo và nhân ra kết quả 4/15", isBug: false }
        ],
      ...
      {
        title: "Bẫy Thứ tự ưu tiên trong biểu thức có phân số",
        problem: "Tính giá trị biểu thức: 3 − 5/7 × 14/15",
        steps: [
          { num: 1, text: "Thực hiện phép trừ trước từ trái sang phải: 3 − 5/7 = 21/7 − 5/7 = 16/7", isBug: true },
          { num: 2, text: "Lấy 16/7 nhân với 14/15: (16 × 2)/15 = 32/15", isBug: false },
          { num: 3, text: "Kết luận giá trị biểu thức là 32/15", isBug: false }
        ],
      ...
      {
        title: "Bẫy Quy đồng mẫu số của 3 phân số",
        problem: "Quy đồng mẫu số ba phân số: 2/3, 3/4 và 5/6",
        steps: [
          { num: 1, text: "Chọn mẫu số chung là 3 × 4 × 6 = 72", isBug: false },
          { num: 2, text: "Hoặc chọn mẫu số chung nhỏ nhất là 12 (vì 12 chia hết cho cả 3, 4, 6)", isBug: false },
          { num: 3, text: "Quy đồng với mẫu số 12: 2/3 = 8/12; 3/4 = 9/12; 5/6 = 15/12 (nhân tử số với 3 thay vì nhân với 2)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Nhân phân số với số tự nhiên",
        problem: "Tính giá trị: 5/18 × 6",
        steps: [
          { num: 1, text: "Chuyển phép tính về dạng nhân phân số: 5/18 × 6/1", isBug: false },
          { num: 2, text: "Nhân cả tử số và mẫu số với 6: (5 × 6)/(18 × 6) = 30/108", isBug: true },
          { num: 3, text: "Rút gọn phân số 30/108 = 5/18 (thấy không đổi)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Chia phân số cho số tự nhiên",
        problem: "Tính giá trị: 8/15 : 4",
        steps: [
          { num: 1, text: "Quy ước viết số tự nhiên 4 dưới dạng phân số: 8/15 : 4/1", isBug: false },
          { num: 2, text: "Nhân số tự nhiên 4 vào tử số: (8 × 4)/15 = 32/15", isBug: true },
          { num: 3, text: "Kết luận kết quả là 32/15", isBug: false }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Phân số của số gạo CÒN LẠI",
        ...
        steps: [
          { num: 1, text: "Buổi sáng bán được: 1 250 × 2/5 = 500 (kg)", isBug: false },
          { num: 2, text: "Buổi chiều bán được: 1 250 × 3/4 = 937.5 (kg) (lấy phân số nhân với tổng ban đầu)", isBug: true },
          { num: 3, text: "Cộng hai buổi ra số gạo lớn hơn 1 250 kg", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tìm học sinh còn lại sau hai đợt phân loại",
        ...
        steps: [
          { num: 1, text: "Số học sinh giỏi là: 40 × 3/8 = 15 (học sinh)", isBug: false },
          { num: 2, text: "Số học sinh còn lại sau khi trừ học sinh giỏi: 40 − 15 = 25 (học sinh)", isBug: false },
          { num: 3, text: "Số học sinh khá là: 40 × 4/5 = 32 (học sinh) (nhân với cả lớp)", isBug: true },
          { num: 4, text: "Thấy 15 + 32 = 47 > 40 học sinh", isBug: false }
        ],
      ...
      {
        title: "Bẫy Trừ thẳng số tự nhiên cho phân số",
        problem: "Một kho gạo có 1 500 kg, ngày đầu xuất bán 1/3 số gạo. Hỏi trong kho còn lại bao nhiêu ki-lô-gam gạo?",
        steps: [
          { num: 1, text: "Lấy số gạo trong kho trừ thẳng cho phân số: 1 500 − 1/3", isBug: true },
          { num: 2, text: "Tính ra 1 499 và 2/3 kg", isBug: false },
          { num: 3, text: "Ghi đáp số: Trong kho còn lại 1 499 và 2/3 kg", isBug: false }
        ],
      ...
      {
        title: "Bẫy Tìm một số biết giá trị một phân số của nó",
        problem: "Tìm số sách trong thư viện, biết rằng 3/5 số sách của thư viện là 750 cuốn.",
        steps: [
          { num: 1, text: "Muốn tìm số sách thư viện, ta lấy: 750 × 3/5", isBug: true },
          { num: 2, text: "Tính: (750 : 5) × 3 = 450 (cuốn)", isBug: false },
          { num: 3, text: "Kết luận thư viện có 450 cuốn sách", isBug: false }
        ],
      ...
      {
        title: "Bẫy Diện tích phần đất còn lại sau khi đào ao",
        ...
        steps: [
          { num: 1, text: "Diện tích mảnh đất là: 80 × 50 = 4 000 (m²)", isBug: false },
          { num: 2, text: "Phân số chỉ diện tích phần đất còn lại là: 1 − 2/5 = 3/5", isBug: false },
          { num: 3, text: "Diện tích phần đất còn lại là: 4 000 : 3 × 5 = 6 666 (m²)", isBug: true }
        ],
      ...
      },
      {
        ...
        steps: [
          { num: 1, text: "Lần 1 cắt: 90 × 1/3 = 30 (m)", isBug: false },
          { num: 2, text: "Số mét vải còn lại sau lần 1: 90 − 30 = 60 (m)", isBug: false },
          { num: 3, text: "Lần 2 cắt: 90 × 2/3 = 60 (m)", isBug: true },
          { num: 4, text: "Kết luận cuộn vải hết sạch: 60 − 60 = 0 (m)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Góp tiền mua đồ dùng học tập",
        ...
        steps: [
          { num: 1, text: "Bách góp: 120 000 × 1/3 = 40 000 (đồng)", isBug: false },
          { num: 2, text: "Nam góp: 120 000 × 2/5 = 48 000 (đồng)", isBug: false },
          { num: 3, text: "Minh góp số tiền là: 120 000 − 40 000 + 48 000 = 128 000 (đồng)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Hai vòi cùng chảy vào bể nước",
        ...
        steps: [
          { num: 1, text: "Trong 1 giờ vòi 1 chảy: 2 400 × 1/3 = 800 (lít)", isBug: false },
          { num: 2, text: "Trong 1 giờ vòi 2 chảy: 2 400 × 1/4 = 600 (lít)", isBug: false },
          { num: 3, text: "Cả hai vòi chảy trong 1 giờ: 800 − 600 = 200 (lít)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Đổi đơn vị khối lượng kết hợp phân số",
        problem: "Một kho có 3 tấn 6 tạ gạo. Người ta bán đi 2/9 số gạo đó. Hỏi trong kho còn lại bao nhiêu ki-lô-gam gạo?",
        steps: [
          { num: 1, text: "Đổi: 3 tấn 6 tạ = 3 600 kg", isBug: false },
          { num: 2, text: "Số gạo đã bán là: 3 600 × 2/9 = 800 (kg)", isBug: false },
          { num: 3, text: "Đáp số: Trong kho còn lại 800 kg gạo", isBug: true }
        ],
      ...
      {
        title: "Bẫy Toán rút về đơn vị tỉ lệ phân số",
        problem: "May 8 bộ quần áo đồng phục hết 20m vải. Hỏi may 16 bộ quần áo như thế hết bao nhiêu mét vải?",
        steps: [
          { num: 1, text: "16 bộ gấp 8 bộ số lần là: 16 : 8 = 2 (lần)", isBug: false },
          { num: 2, text: "May 16 bộ cần số mét vải là: 20 : 2 = 10 (m)", isBug: true },
          { num: 3, text: "Đáp số: 10m vải", isBug: false }
        ],
  ...
  },
  {
    ...
    cases: [
      {
        title: "Bẫy Trồng cây hai đầu đường thẳng",
        ...
        steps: [
          { num: 1, text: "Số khoảng cách trên một bên đường là: 1 200 : 15 = 80 (khoảng)", isBug: false },
          { num: 2, text: "Vì hai đầu đều có cây nên số cây một bên là: 80 cây", isBug: true },
          { num: 3, text: "Số cây cả hai bên đường là: 80 × 2 = 160 (cây)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Trồng cây khép kín quanh bờ hồ hình chữ nhật",
        ...
        steps: [
          { num: 1, text: "Chu vi bờ hồ là: (150 + 90) × 2 = 480 (m)", isBug: false },
          { num: 2, text: "Số khoảng cách là: 480 : 6 = 80 (khoảng)", isBug: false },
          { num: 3, text: "Vì trồng cây nên cộng thêm 1: 80 + 1 = 81 (cây)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Tỉ lệ nghịch trong bài toán đội thợ đắp đê",
        ...
        steps: [
          { num: 1, text: "Số ngày giảm đi số lần là: 8 : 4 = 2 (lần)", isBug: false },
          { num: 2, text: "Vì số ngày giảm 2 lần nên số người cũng giảm 2 lần: 15 : 2 = 7.5 (người)", isBug: true },
          { num: 3, text: "Ghi kết quả cần 7.5 người (hoặc làm tròn thành 8 người)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Số lần cưa và số lần nghỉ",
        ...
        steps: [
          { num: 1, text: "Số đoạn gỗ cắt được: 12 : 2 = 6 (đoạn)", isBug: false },
          { num: 2, text: "Cắt 6 đoạn cần 6 lần cưa", isBug: true },
          { num: 3, text: "Thời gian cưa: 6 × 6 = 36 phút; nghỉ: 6 × 3 = 18 phút. Tổng = 54 phút", isBug: false }
        ],
      ...
      {
        title: "Bẫy Đếm số chữ số dùng để đánh số trang sách",
        problem: "Để đánh số trang một cuốn sách dày 125 trang (từ trang 1 đến trang 125), người ta phải dùng tất cả bao nhiêu chữ số?",
        steps: [
          { num: 1, text: "Từ trang 1 đến trang 9 có: (9 − 1 + 1) × 1 = 9 (chữ số)", isBug: false },
          { num: 2, text: "Từ trang 10 đến trang 99 có: (99 − 10 + 1) × 2 = 180 (chữ số)", isBug: false },
          { num: 3, text: "Từ trang 100 đến trang 125 có: (125 − 100) × 3 = 75 (chữ số)", isBug: true },
          { num: 4, text: "Tổng số chữ số là: 9 + 180 + 75 = 264 chữ số", isBug: false }
        ],
      ...
      {
        title: "Bẫy Số khoảng thời gian giữa các tiếng chuông đồng hồ",
        ...
        steps: [
          { num: 1, text: "Đếm số tiếng chuông: từ tiếng 1 đến tiếng 5 có 5 tiếng chuông", isBug: false },
          { num: 2, text: "Thời gian cho mỗi tiếng chuông là: 12 : 5 = 2.4 (giây)", isBug: true },
          { num: 3, text: "Thời gian cho 9 tiếng chuông: 2.4 × 9 = 21.6 (giây)", isBug: false }
        ],
      ...
      {
        title: "Bẫy Leo cầu thang giữa các tầng lầu",
        ...
        steps: [
          { num: 1, text: "Từ tầng 1 lên tầng 3 là 3 tầng lầu: 36 : 3 = 12 giây/tầng", isBug: true },
          { num: 2, text: "Từ tầng 1 lên tầng 6 là 6 tầng: 12 × 6 = 72 (giây)", isBug: false },
          { num: 3, text: "Đáp số: 72 giây", isBug: false }
        ],
      ...
      {
        title: "Bẫy Đổi đơn vị và nhóm xe trong bài toán vận chuyển",
        ...
        steps: [
          { num: 1, text: "Đổi: 3 tấn 5 tạ = 35 tạ; 4 tấn 2 tạ = 42 tạ", isBug: false },
          { num: 2, text: "Tổng số tạ gạo: 4 × 35 + 3 × 42 = 140 + 126 = 266 (tạ)", isBug: false },
          { num: 3, text: "Tổng số xe: 4 + 3 = 7 (xe)", isBug: false },
          { num: 4, text: "Trung bình mỗi xe chở: 266 : 2 = 133 (tạ) (chia cho 2 loại xe)", isBug: true }
        ],
      ...
      {
        title: "Bẫy Tính thời gian tàu hỏa chạy qua cầu",
        problem: "Một đoàn tàu hỏa dài 150m chạy qua một cây cầu dài 450m mất 30 giây. Tính vận tốc của đoàn tàu theo mét/giây.",
        steps: [
          { num: 1, text: "Khi tàu đi qua cầu, mũi tàu vào cầu đến khi đuôi tàu ra khỏi cầu thì quãng đường tàu đi là: 450m (bằng chiều dài cây cầu)", isBug: true },
          { num: 2, text: "Vận tốc của tàu là: 450 : 30 = 15 (m/giây)", isBug: false },
          { num: 3, text: "Đáp số: 15 m/s", isBug: false }
        ],
      ...
      {
        title: "Bẫy Năm 1010 thuộc thế kỷ nào",
        problem: "Năm 1010, vua Lý Thái Tổ dời đô từ Hoa Lư về Thăng Long. Hỏi năm 1010 thuộc thế kỷ nào?",
        steps: [
          { num: 1, text: "Lấy 1010 chia cho 100 được 10 dư 10", isBug: false },
          { num: 2, text: "Vì được thương là 10 nên kết luận năm 1010 thuộc thế kỷ 10 (X)", isBug: true },
          { num: 3, text: "Đáp số: Thế kỷ X", isBug: false }
        ],
...
function getBugCaseDifficulty(topicIndex, caseIndexInTopic) {
  if (topicIndex < 3) {
    // Chuyên đề 1-3: Khởi động nền tảng
    if (caseIndexInTopic < 3) return 1; // Độ khó 1/5: Bẫy cơ bản
    if (caseIndexInTopic < 6) return 2; // Độ khó 2/5: Bẫy vừa sức
    if (caseIndexInTopic < 8) return 3; // Độ khó 3/5: Bẫy khá
    return 4; // Độ khó 4/5: Bẫy nâng cao
  }
  if (topicIndex < 8) {
    // Chuyên đề 4-8: Vận dụng thực tế & Đa bước
    if (caseIndexInTopic < 2) return 2; // Độ khó 2/5
    if (caseIndexInTopic < 5) return 3; // Độ khó 3/5
    if (caseIndexInTopic < 8) return 4; // Độ khó 4/5
    return 5; // Độ khó 5/5: Bẫy Olympic / Rất tinh vi
  }
  // Chuyên đề 9-12: Phân số & Tỉ số nâng cao
  if (caseIndexInTopic < 2) return 3; // Độ khó 3/5
  if (caseIndexInTopic < 6) return 4; // Độ khó 4/5
  return 5; // Độ khó 5/5: Olympic Toán tuổi thơ
}

// Flat list of 120 cases
export const ALL_120_BUG_CASES = [];
let caseCounter = 1;
for (let tIdx = 0; tIdx < TOPICS.length; tIdx++) {
  const topic = TOPICS[tIdx];
  for (let cIdx = 0; cIdx < topic.cases.length; cIdx++) {
    const c = topic.cases[cIdx];
    ALL_120_BUG_CASES.push({
      id: `bug-${caseCounter}`,
      index: caseCounter - 1,
      topic: topic.name,
      difficulty: getBugCaseDifficulty(tIdx, cIdx),
      title: `Vụ án ${caseCounter}: ${c.title}`,
      problem: c.problem,
      steps: c.steps,
      bugExplanation: c.bugExplanation,
...
// Generate the complete js/spot-the-bug.js
const targetFile = new URL("../js/spot-the-bug.js", import.meta.url).pathname;
const fileContent = `// js/spot-the-bug.js - Mini-game "AI Thám Tử Bắt Lỗi Sai" (Spot The Bug)
// Ngân hàng 120 bẫy sai lầm kinh điển bám sát 12 chuyên đề chuẩn mực Toán Lớp 4

export const BUG_TOPICS = ${JSON.stringify(TOPICS.map(t => ({ name: t.name, count: t.cases.length })), null, 2)};

export const BUG_CASES = ${JSON.stringify(ALL_120_BUG_CASES, null, 2)};
...
console.log(`Successfully generated and written ${ALL_120_BUG_CASES.length} high-grade bug cases to ${targetFile}!`);
